...
$query = "SELECT * FROM `695_txt` WHERE `eventcd` LIKE 'ICC' AND `Date1` LIKE '$custom' AND `exchgcntry` LIKE 'US' LIMIT 1";
...
('', '$a_stock_id', '$a_symbol', '$a_date', '$a_name', '$a_stock_status', '$a_exchange', '$field5', '$a_fb_stockkey', '$a_fb_aliaskey', '$a_sector', '$a_style', '$a_current')";
            ...
            $old_alias_update = "UPDATE `stock_alias` SET `current` = '0' WHERE `stock_alias`.`uid` = '$uid';";
