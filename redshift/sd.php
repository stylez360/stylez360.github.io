...
$query = "SELECT * FROM `695_txt` WHERE `eventcd` LIKE 'SD' AND `Date1` LIKE '$today' AND `exchgcntry` LIKE 'US' AND `localcode` NOT LIKE '% %'";
...
('', '$actionid', '$symbol', '$name', '$cusip', '$issue_date', '$update_date', '$effective_date', '3001', '$split_terms', '$split_ratio', '', '$alias_id', '');";
            print $insert_query;
                try{
