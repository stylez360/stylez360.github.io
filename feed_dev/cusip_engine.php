...
$file = fopen('http://www.xignite.com/xGlobalHistorical.json/GetGlobalHistoricalQuotes', 'rb', false, $context) or die ("Merchant Services Not Responding");
...
foreach($json as $key => $value)
    ...
    //print "###############".$Identity."#####################";
    $cusip_insert = "INSERT INTO `feed_data`.`cusip_feed` (
            `uid`,
            `Symbol`,
            `Cusip`,
            `Market`)
