...
foreach($array as $kkey => $exc)
    {
    $url_string = 'Exchange='.$exc.'&StartSymbol=A&EndSymbol=M&_Token=EF2662FA141B4DC086F6A72B2D15AD2C';
    $opts = array('http'=>
            array('method' =>'POST',
                    'port' =>'443',
    ...
    foreach($pieces as $key => $value)
        ...
        $total++;
        $symbol_insert = "INSERT INTO `feed_data`.`symbol_feed2` (
            `uid`,
            `Symbol`,
            `Currency`,
            `Name`)
        ...
        //print "<br>-----------------------------------------------------------------------------------------------------<br>";
            $url_string = 'Exchange='.$exc.'&StartSymbol=N&EndSymbol=Z&_Token=EF2662FA141B4DC086F6A72B2D15AD2C';
    $opts = array('http'=>
            array('method' =>'POST',
                    'port' =>'443',
                    'header' =>'Content-type: application/x-www-form-urlencoded',
