...
if ($status != "delisted" && $count > 0)
    {
    //print $symbol;
    $insert_query = "INSERT INTO `stock`.`cash_dividend_ca` (`uid`, `action_id`, `symbol`, `name`, `cusip`, `issue_date`, `update_date`, `effective_date`, `record_date`, `pay_date`, `frequency`, `net_amount`, `gross_amount`, `currency`, `notes`, `alias_id`, `fb_aliaskey`) VALUES ('','".$actionid."','".$symbol."','".$name."','".$cusip."','".$issue_date."','".$update_date."','".$effective_date."','".$record_date."','".$pay_date."','".$frequency."','".$net_amount."','".$gross_amount."','".$currency."','".$notes."','".$alias_id."','".$fb_aliaskey."')";
            print $insert_query;
                try{
