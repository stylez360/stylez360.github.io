...
if ($status != "delisted" && $count > 0)
    {
    //print $symbol;
    $insert_query = "INSERT INTO `stock`.`stock_split_ca` (`uid`, `action_id`, `symbol`, `name`, `cusip`, `issue_date`, `update_date`, `effective_date`, `split_type`, `split_terms`, `split_ratio`, `notes`, `alias_id`, `fb_aliaskey`) VALUES ('','".$actionid."','".$symbol."','".$name."','".$cusip."','".$issue_date."','".$update_date."','".$effective_date."','3000','".$split_terms."','".$split_ratio."','".$notes."','".$alias_id."','".$fb_aliaskey."')";
            print $insert_query;
                try{
