...
if ($status != "delisted" && $count > 0)
    {
    //print $symbol;
    $insert_query = "INSERT INTO `stock`.`stock_dividend_ca` (`uid`, `action_id`, `symbol`, `name`, `cusip`, `issue_date`, `update_date`, `effective_date`, `record_date`, `pay_date`, `stock_dividend_type`, `dividend_symbol`, `adjustment`, `adjustment_date`, `notes`, `alias_id`, `fb_aliaskey`) VALUES ('','".$actionid."','".$symbol."','".$name."','".$cusip."','".$issue_date."','".$update_date."','".$effective_date."','".$record_date."','".$pay_date."','".$stock_dividend_type."','".$dividend_symbol."','".$adjustment_date."','".$adjustment."','".$notes."','".$alias_id."','".$fb_aliaskey."')";
            print $insert_query;
                /*try{
