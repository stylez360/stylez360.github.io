<!DOCTYPE html>
<!-- saved from url=(0052)https://stylez360.github.io/orders_customers.aspx -->
<html lang="en" class="fa-events-icons-ready"><head id="Head1"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no"><meta name="ROBOTS" content="NOINDEX, NOFOLLOW"><link type="text/css" rel="stylesheet" href="./orders_customers_files/main.css">
    <script async="" src="./orders_customers_files/clarity.js.download"></script><script async="" src="./orders_customers_files/8funo71987"></script><script async="" src="./orders_customers_files/profitwell.js.download"></script><script type="text/javascript" async="" src="./orders_customers_files/analytics.js.download"></script><script type="text/javascript" async="" src="./orders_customers_files/js"></script><script type="text/javascript" async="" src="./orders_customers_files/analytics.js.download"></script><script>
        ...
        <link type="text/css" rel="stylesheet" class="cp_theme_stylesheet_link" href="./orders_customers_files/fws_pink.css">
        <script async="" src="./orders_customers_files/js(1)"></script>
        <script>
    ...
    <script src="./orders_customers_files/purify.min.js.download"></script><script src="./orders_customers_files/cleanxss.js.download"></script><link type="text/css" rel="stylesheet" href="./orders_customers_files/base_elements.css"><link type="text/css" rel="stylesheet" href="./orders_customers_files/light.css">
    <link rel="stylesheet" type="text/css" href="./orders_customers_files/products.css">
    <link rel="stylesheet" type="text/css" href="./orders_customers_files/customers.css">
    <link rel="stylesheet" type="text/css" href="./orders_customers_files/reusable.css">
    <script src="./orders_customers_files/moment.min.js.download" type="text/javascript"></script>
<link href="./orders_customers_files/css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="./orders_customers_files/stylesheet.min.css">
    <link href="./orders_customers_files/css(1)" rel="stylesheet">
    <script src="./orders_customers_files/c2dd136024.js.download"></script><link href="./orders_customers_files/c2dd136024.css" media="all" rel="stylesheet">
    <script src="./orders_customers_files/polyfill.min.js.download"></script>
    <script>
    ...
    <script src="./orders_customers_files/axios.js.download"></script><script src="./orders_customers_files/js.cookie.js.download"></script><script src="./orders_customers_files/utilities.js.download"></script><script src="./orders_customers_files/ua-parser.min.js.download"></script><script src="./orders_customers_files/user.js.download"></script>
    <!-- Add a reference to the clientside currency lib-->
    <script src="./orders_customers_files/accountingCurrency.js.download"></script><title>

</title><link rel="prefetch"></head>
<body id="dashboard" data-instant-allow-query-string="" style="overflow: unset;">
    <script src="./orders_customers_files/preload.js.download"></script>
    <form method="post" action="https://stylez360.github.io/orders_customers.aspx" id="form1" enctype="multipart/form-data" role="form">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="8A3sliB/j3aNXZ9ccQcxGTwBXPQyj8S4Haal/6pfyUUgp96kwQ7qb6TPhYbXLZG+m1eSnhRmwDWf+vQ5/SVX0UY1y4hltPnoEz5DWYE9fGs=">
</div>

<script src="./orders_customers_files/jquery-1.11.3.min.js.download"></script><script src="./orders_customers_files/jqueryuiclone1_12_1.js.download"></script>
<div class="aspNetHidden">

	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="B603F0F7">
</div>
...
<div id="breadcrumbs_main_container"><div id="breadcrumbs"><div class="breadcrumbs_container"><a href="https://stylez360.github.io/main.aspx" title="Back to Homepage"><i class="fa fa-home" aria-hidden="true"></i></a><a id="" href="https://stylez360.github.io/orders.aspx">Orders</a><a id="" href="https://stylez360.github.io/orders_customers.aspx">Customers</a></div><div id="breadcrumbs_save" data-tourid="save-the-page"><a class="main_save_button button button_primary button_disabled has_tool_tip" onclick="runSaveButton();"><span class="tool_tip tool_tip_bottom tool_tip_red">Change something first!</span>Save</a></div></div></div>
...
<script>
    ...
    <script>
        var mainBreadcrumbs = {
            "breadcrumbs": [
                { "name": "Orders", "link": "/orders.aspx" },
                { "name": "Customers", "link": "/orders_customers.aspx" }
            ],
            "save": true
        }
        createBreadcrumbs();
        ...
        <div class="layout1">
            ...
            <div class="layout1_right_mobile">
                ...
                <div class="panel_white">
                    <div class="busy_wait busy_wait_static busy_wait_settings_customer" style="display: none;">
                        <div class="busy_wait_content">
                            ...
                            <span>Loading Customer Settings</span>
                        </div>
                    </div>
                    <div id="settings_customer_container" style="display: block;">
                            <div class="panel_section">
                                <h2>Customer Accounts</h2>
                                <p>Use this section to activate and customize the Customer Accounts feature.</p>
                            </div>

                            <div>
                                <div class="hide_overflow">
                                    <p><strong>Customer Accounts</strong><span class="static_tool_tip right" onclick="inputHelpText(&#39;customerAccounts&#39;)">?</span></p>
                                    <div class="input_help_text" data-help="customerAccounts">
                                        <p>Customers can create Accounts to save their address details, view previous orders and speed up the checkout process. Disable this option if you wish your customers to enter their address details each time they buy from your store.</p>
                                    </div>
                                    <div class="checkbox_container">
                                        <input type="radio" id="settings_basket_accEnable" name="settings_basket_customer" onclick="customerAccountChange();">
                                        <label for="settings_basket_accEnable"><span><i class="fa fa-lock marginr5 plan_lock_icon"></i>Enable Customer Accounts</span></label>
                                    </div>
                                    <div class="checkbox_container ">
                                        <input type="radio" id="settings_basket_accDisable" name="settings_basket_customer" onclick="customerAccountChange();">
                                        <label for="settings_basket_accDisable"><span>Disable Customer Accounts</span></label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="guest_checkout">
                                ...
                                <div class="hide_overflow">
                                    <p><strong>Guest Checkout</strong><span class="static_tool_tip right" onclick="inputHelpText(&#39;guestAccounts&#39;)">?</span></p>
                                    <div class="input_help_text" data-help="guestAccounts">
                                        <p>This feature allows shoppers to have the option to Checkout as Guest (where they are required to enter their address details each time they buy from your store). If this option is disabled, shoppers must create or log into an account in order to checkout.</p>
                                    </div>
                                    <div class="checkbox_container">
                                        <input type="radio" id="settings_basket_guestEnable" name="settings_basket_guest" onclick="customerAccountChange();">
                                        <label for="settings_basket_guestEnable"><span>Allow Checkout as Guest</span></label>
                                    </div>
                                    <div class="checkbox_container ">
                                        <input type="radio" id="settings_basket_guestDisable" name="settings_basket_guest" onclick="customerAccountChange();">
                                        <label for="settings_basket_guestDisable"><span>Mandatory Customer Accounts</span></label>
                                    </div>
                                </div>
                                <div class="hide_overflow" id="wishlist_container">
                                    <div id="wishlist_not_available" class="bootstrap_warning">
                                        Wishlists are not available on your current theme. Switch your theme <a href="https://stylez360.github.io/design_switch_design.aspx" class="link_color_dgrey">here</a>.
                                    </div>
                                    <p><strong>Wishlists</strong><span class="static_tool_tip right" onclick="inputHelpText(&#39;wishlist&#39;)">?</span></p>
                                    <div class="input_help_text" data-help="wishlist">
                                        <p>The feature allows your customers to add products to their wishlist. They can view their wishlist within their account.</p>
                                    </div>
                                    <div class="checkbox_container">
                                        <input type="radio" id="settings_basket_wishlist_enable" name="settings_basket_wishlist" onchange="wishlistChange();">
                                        <label for="settings_basket_wishlist_enable"><span>Enable Wishlists</span></label>
                                    </div>
                                    <div class="checkbox_container ">
                                        <input type="radio" id="settings_basket_wishlist_disable" name="settings_basket_wishlist" onchange="wishlistChange();" checked="">
                                        <label for="settings_basket_wishlist_disable"><span>Disable Wishlists</span></label>
                                    </div>
                                </div>
                ...
                <div class="panel_white" id="customers_filters_outer_panel" style="display: none;">
                    <div class="busy_wait busy_wait_static busy_wait_customers_filters" style="display: none;">
                        <div class="busy_wait_content">
                            <div class="sk-cube-grid">
                                <div class="sk-cube sk-cube1"></div>
                                <div class="sk-cube sk-cube2"></div>
                            ...
                            <span>Loading Your Customers</span>
                        </div>
                    </div>
                    <div id="customers_filters_panel" style="display: block;">
                        <h2>Page View</h2>

                        <div class="panel_section">
                            <p>Use the check buttons below to show and hide diffent customer attributes.</p>
                            <div class="input_container inline_checkboxes customer_lists_types">

                                <div class="checkbox_container">
                                    <input type="checkbox" id="customer_list_type_item2" name="customer_list_type_item" checked="checked">
                                    <label for="customer_list_type_item2"><span>Type</span></label>
                                </div>
                                <div class="checkbox_container">
                                    <input type="checkbox" id="customer_list_type_item5" name="customer_list_type_item">
                                    <label for="customer_list_type_item5"><span>Created</span></label>
                                </div>
                                <div class="checkbox_container">
                                    <input type="checkbox" id="customer_list_type_item6" name="customer_list_type_item" checked="checked">
                                    <label for="customer_list_type_item6"><span>Orders</span></label>
                                </div>
                                <div class="checkbox_container">
                                    <input type="checkbox" id="customer_list_type_item7" name="customer_list_type_item">
                                    <label for="customer_list_type_item7"><span>Turnover</span></label>
                                </div>
                            </div>
                        </div>
                        <div class="panel_section">
                            <div class="input_container">
                                <label>Sort By</label>
                                <select id="dlSort">
                                    <option value="createddesc" selected="selected">Date (Newest - Oldest)</option>
                                    <option value="created">Date (Oldest - Newest)</option>
                                    
                                    <option value="surname">Last Name (aA - zZ)</option>
                                    <option value="surnamedesc">Last Name (Zz - Aa)</option>
                                    
                                    <option value="forename">First Name (aA - zZ)</option>
                                    <option value="forenamedesc">First Name (Zz - Aa)</option>
                                    
                                    <option value="companyname">Company Name (aA - zZ)</option>
                                    <option value="companynamedesc">Company Name (Zz - Aa)</option>

                                    <option value="email">Email (aA - zZ)</option>
                                    <option value="emaildesc">Email (Zz - Aa)</option>

                                    <option value="total_sales">Turnover (Least - Most)</option>
                                    <option value="total_salesdesc">Turnover (Most - Least)</option>
                                    
                                    <option value="total_orders">Orders Placed (Least - Most)</option>
                                    <option value="total_ordersdesc">Orders Placed (Most - Least)</option>
                                </select>
                            </div>
                            <div class="input_container">
                                <label>Page Size</label>
                                <select id="dlSize">
                                    <option data-size="10">10</option>
                                    <option data-size="25">25</option>
                                    <option data-size="50" selected="selected">50</option>
                                    <option data-size="100">100</option>
                                </select>
                            </div>
                        </div>
            ...
            <div class="layout1_left_mobile">
                <div id="customers_top_search_bar" class="panel panel_overflow border_bottom_5" style="display: none;">
                    <div class="quicksearch_results_container" style="display: none;">
                        <div class="input_container input_container_button">
                            <input id="txtQuickSearch" type="search" placeholder="Search Customers..." autocomplete="off">
                        </div>
                    ...
                    <!--<a class="button button_primary right" onclick="addNewCustomer();">Add Customer</a>-->
                    <a href="https://stylez360.github.io/orders_customers_export" class="button button_primary right">Export</a>
                </div>

                <div class="panel panel_red overlimit_panel">
                    <h2>You have over 10,000 customers. Lucky you!</h2>
                    <p>Over 10,000 customer matches have been found. To see customers over the 10,000 mark you will need to use the filters in the <strong>Page View</strong> panel or use the <strong>Search</strong> to search for individual customers.</p>
                </div>
                <div class="overlimit">Fetched <strong class="overlimit1"></strong> of <strong class="overlimit2"></strong> customers</div>
                <div class="pagination hide_overflow" data-type="customer" style="display: none;"></div>
                <div class="panel_white">
                    <div class="busy_wait busy_wait_static busy_wait_customers" style="display: none;">
                        <div class="busy_wait_content">
                            <div class="sk-cube-grid">
                                <div class="sk-cube sk-cube1"></div>
                                <div class="sk-cube sk-cube2"></div>
                    ...
                    <div class="zero_customers_found align_center" style="display: block;">
                        <h2>Your customers will show here</h2>
                        <p>When you receive an order, or a shopper signs up for an account on your store, they will appear here.</p>
                        <!--<a class="button button_primary" onclick="addNewCustomer();">Add New Customer</a>-->
                    </div>
                    <div class="table_container">
                        <table id="customers_table" style="display: none;">
                            <thead>
                                <tr>
                                    <th></th>
                                    
                                    <th class="table_header_titles_type">Account Type</th>
                                    <th class="table_header_titles_customer">Customer</th>
                                    <th class="table_header_titles_created list_table_hidden">Created</th>
                                    <th class="table_header_titles_orders">Orders</th>
                                    <th class="table_header_titles_revenue list_table_hidden">Turnover</th>
                                    <th class="table_header_titles_delete"></th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
                ...
                <div class="pagination hide_overflow" data-type="customer"></div>
            </div>
    ...
    <script src="./orders_customers_files/Customers.js.download"></script>
    <script src="./orders_customers_files/pagination.js.download"></script>
    <script>
        var startpg = 0;
        
        $('#btnQuickSearch').click(function () {
            SearchCustomer(storeId, $('#txtQuickSearch').val());
        });
        ...
        function GetDateString(when) {
            ...
            //console.log("Mins difference :"+mins);
            ...
            /*
            if(moment(when).diff(moment.now(), 'days')<-1)
            {
                console.log('Event happend less than a day ago');
                //userDate = moment(when).calendar();
                //moment(this.when).format('LLL');
                userDate = moment(when).local().format('YYYY-MMM-DD h:mm A');
            }
            */
        ...
        function QuickProductSearch(q) {
            ...
            jQuery.ajax({
                async: true,
                cache: false,
                url: "/services/Customers.svc/quickSearch?storeId=" + storeId + "&q=" + q + "&start=" + start + "&pgsize=" + pgsize,
            dataType: "json",
                ...
                if (search.found > 0) {
                    ...
                    $.each(search.list, function () {
                        ...
                        $("#quicksearch_results").append("<li class='quicksearch_results_item'>" +
                            "<a href=\"orders_customers_view.aspx?cid=" + $(this)[0].Key + "\" class='hide_overflow'>" +
                            "<img class='quicksearch_results_item_image' src=" + $(this)[0].Value[0] + ">" +
                            "<div class='quicksearch_results_item_text'>" +
                            "<div class='quicksearch_results_item_text1'>" + $(this)[0].Value[2] + " " + $(this)[0].Value[3] + "</div>" +
                            "<div class='quicksearch_results_item_text2'>" + $(this)[0].Value[1] + "</div>" +
                            "</div>" +
                            "</a>" +
                            "</li>");
                    });
        ...
        function addNewCustomer() {
            $(".modal_doverlay, .modal_x_button, .modal_link_customer").fadeIn();
        }
...
<link type="text/css" rel="stylesheet" href="./orders_customers_files/billing.css">
    ...
    <div class="modal_body_outer_container">
        <div class="modal_body">
            ...
            <div id="modal_billingv2_list_payment_methods_error" class="align_center paddingt20">
                ...
                <p>Please <a class="button button_primary" onclick="billingv2CheckPaymentMethods();">try again</a> or <a href="https://stylez360.github.io/support_new_ticket.aspx" class="link_color_primary">contact support</a>.</p>
            </div>
...
<script src="./orders_customers_files/billing.js.download"></script>
...
<div class="modal modal_vat_setup">
    ...
    <div class="modal_body_outer_container" id="modal_container_vat_setup">
        ...
        <div id="modal_body_vat_subscription" class="modal_body align_center paddingt10 paddingb10">
            ...
            <a href="https://stylez360.github.io/support_new_ticket.aspx" class="button button_primary button_table">Contact Support</a>
        </div>
...
<link type="text/css" rel="stylesheet" href="./orders_customers_files/billing_overview.css">
    ...
    <div class="modal_body_outer_container">
        <div class="modal_body paddingt20 paddingb20">
            ...
            <div id="modal_billingv2_overview_check_vat_error" class="align_center paddingt20">
                ...
                <p>Please <a class="button button_primary" onclick="buildBillingV2Overview();">try again</a> or <a href="https://stylez360.github.io/support_new_ticket.aspx" class="link_color_primary">contact support</a>.</p>
            </div>
            ...
            <div id="modal_billingv2_overview_container">
                ...
                <div id="modal_billingv2_overview_details">
                    <div id="modal_billingv2_overview_details_image_container">
                        <img id="modal_billingv2_overview_details_image" src="./orders_customers_files/icon.jpg">
                    </div>
                ...
                <div id="modal_billingv2_overview_card_container">
                    ...
                    <div id="modal_billingv2_overview_general_error" class="align_center">
                        ...
                        <p>Please try again or <a href="https://stylez360.github.io/support_new_ticket.aspx" class="link_color_primary">contact support</a></p>
                    </div>
...
<script src="./orders_customers_files/three-d-secure.min.js.download"></script>
<script src="./orders_customers_files/data-collector.min.js.download"></script>
<script src="./orders_customers_files/billing_overview.js.download"></script>


<link type="text/css" rel="stylesheet" href="./orders_customers_files/billing_cards_in_vault.css">
...
<script src="./orders_customers_files/billing_cards_in_vault.js.download"></script>


<link type="text/css" rel="stylesheet" href="./orders_customers_files/billing_no_cards_in_vault.css">
    ...
    <div class="modal_body_outer_container">
        <div class="modal_body paddingt20 paddingb20">
            ...
            <div id="modal_billingv2_no_cards_in_vault_error" class="align_center paddingt20">
                ...
                <p>Please <a class="button button_primary" onclick="loadBillingV2AddPaymentMethod();">try again</a> or <a href="https://stylez360.github.io/support_new_ticket.aspx" class="link_color_primary">contact support</a>.</p>
            </div>
...
<script src="./orders_customers_files/dropin.min.js.download" defer=""></script>
<script src="./orders_customers_files/billing_no_cards_in_vault.js.download"></script>


<link type="text/css" rel="stylesheet" href="./orders_customers_files/billing_add_new_card.css">
    ...
    <div class="modal_body_outer_container">
        <div class="modal_body paddingt20 paddingb20">
            ...
            <div id="modal_billingv2_add_new_card_error" class="align_center paddingt20">
                ...
                <p>Please <a class="button button_primary" onclick="loadBillingV2AddPaymentMethodCard();">try again</a> or <a href="https://stylez360.github.io/support_new_ticket.aspx" class="link_color_primary">contact support</a>.</p>
            </div>
...
</div></form><script async="true" id="cc-snippet" src="./orders_customers_files/snippet"></script>

<script src="./orders_customers_files/client.min.js.download" defer=""></script>
<script src="./orders_customers_files/hosted-fields.min.js.download" defer=""></script>
<script src="./orders_customers_files/data-collector.min.js.download" defer=""></script>
<script src="./orders_customers_files/billing_add_new_card.js.download"></script>


<link type="text/css" rel="stylesheet" href="./orders_customers_files/billing_processing.css">
    ...
    <div class="modal_body_outer_container">
        <div class="modal_body paddingt20 paddingb20">
            ...
            <div id="modal_billingv2_processing_case1a_complete" class="align_center paddingt20">
                ...
                <a href="https://stylez360.github.io/main.aspx" class="button button_primary">Close</a>
            </div>
                ...
                <div id="modal_billingv2_processing_case3_success_step2">
					<div id="modal_billingv2_processing_case3_success_step2_help" class="modal_billingv2_processing_error_general_info paddingb10">
						...
						<div id="modal_billingv2_processing_case3_success_step2_help_sent">
							...
							<a href="https://stylez360.github.io/main.aspx" class="button button_primary marginr5">Back to Dashboard</a>
						</div>
					</div>
            ...
            <div id="modal_billingv2_processing_case7_success" class="align_center paddingt20">
                ...
                <a href="https://stylez360.github.io/main.aspx" class="button button_lgrey marginr5">Go To Dashboard</a>
            </div>
            ...
            <div id="modal_billingv2_processing_case9_success" class="align_center paddingt20">
				...
				<p>A verification email will be sent to you within the few hours.</p>
                <a href="https://stylez360.github.io/marketing_domains.aspx" class="button button_lgrey marginr5">Go To Domain Dashboard</a>
            </div>
...
<script src="./orders_customers_files/billing_processing.js.download"></script>

    <div class="modal modal_upgrade_information">
        <div class="modal_header">
            <div class="modal_title">Upgrade Required</div>
            <div class="modal_expand" data-expand="normal"><i class="fa fa-window-maximize" aria-hidden="true"></i></div>
            <div class="modal_close"><i class="fa fa-times" aria-hidden="true"></i></div>
        </div>
        <div class="modal_body_outer_container">
            <div id="upgradeBanner_allow_full_width">
...
<script>
    ...
    $(document).ready(function () {
        if ("False" == "True") {
            $(".section_locked").attr("data-visible", "true");
            $(".section_can_be_locked").attr("data-locked", "true");
            $(".main_save_button").hide();
            $(".save_panel_bottom").hide();
        }

        var benefitListLength = $("#packages_banner_list_benefits_container").html();
        if (benefitListLength) {
            benefitListLength = benefitListLength.trim().length;
        }
        if (benefitListLength == 0) {
            document.getElementById("packages_banner_list_benefits_container").classList.add("packages_banner_list_inner_container_hidden");
            document.getElementById("packages_banner_list_benefits_container_default").classList.add("packages_banner_list_inner_container_single");
        }

        $(".packages_banner_price_additional_pro").html("&dollar;65");
    ...
    <div class="panel_white" id="packages_banner" data-package="startup">

        <div id="packages_banner_title" class="packages_banner_title_dynamic">Upgrade for <span class="color_green">only €0.48</span> per day!</div>
        <div id="packages_banner_subtitle"><i class="fa fa-star"></i><i class="fa fa-star"></i><span>Startup</span></div>
        <div id="packages_banner_info">Unlock <span class="packages_banner_info_highlight">Customer Accounts</span> with the Startup Plan.</div>
        <div id="packages_banner_list">
            <div id="packages_banner_list_benefits_container" class="packages_banner_list_inner_container packages_banner_list_inner_container_hidden">
                
            </div>
            <div id="packages_banner_list_benefits_container_default" class="packages_banner_list_inner_container packages_banner_list_inner_container_single">
                <div class="packages_banner_list_item packages_banner_list_item_specify_title margint40">You Also Receive:</div>
                <div class="packages_banner_list_item"><i class="fa fa-star" aria-hidden="true"></i><span>Free Domain Name</span></div>
                <div class="packages_banner_list_item"><i class="fa fa-check" aria-hidden="true"></i><span>Remove Freewebstore Ads</span></div>
                <div class="packages_banner_list_item"><i class="fa fa-check" aria-hidden="true"></i><span>Earn Up To $100000</span></div>
                <div class="packages_banner_list_item"><i class="fa fa-check" aria-hidden="true"></i><span>Premium Ecommerce Tools</span></div>
                <div class="packages_banner_list_item"><i class="fa fa-check" aria-hidden="true"></i><span>Multiple Payment Gateways</span></div>
                <div class="packages_banner_list_item"><i class="fa fa-check" aria-hidden="true"></i><span>And More...</span></div>
            </div>
        </div>
        <div id="packages_banner_footer">
            <div id="packages_banner_price">$20<span>/mo</span></div>
            <div id="packages_banner_button_container">
                
                    <a class="button button_green" onclick="onTheSpotUpgrade(&#39;12&#39;);">Start Plan</a>
                
                <a href="https://stylez360.github.io/upgrade.aspx" class="link_color_green marginl10 link_word_break">More Information</a>
            </div>
            <div id="packages_banner_cancel_anytime">Cancel at any time.</div>
        </div>
    </div>

     <script>
         var upgradeBannerPromptsTitle = ["Supercharge your store with intelligent business tools!", "Get a <span class='color_green'>free domain name</span> with any upgrade!"];

         if (storeCurrency != null) {

             switch (storeCurrency) {
                 case "GBP":
                     upgradeBannerPromptsTitle.push("Upgrade for <span class='color_green'>only 48p</span> per day!");
                     break;
                 case "EUR":
                     upgradeBannerPromptsTitle.push("Upgrade for <span class='color_green'>only $0.64</span> per day!");
                     break;
                 default:
                     upgradeBannerPromptsTitle.push("Upgrade for <span class='color_green'>only €0.48</span> per day!");
                     break;
             }

         }

         var upgradeBannerPromptsTitleRand = upgradeBannerPromptsTitle[Math.floor(Math.random() * upgradeBannerPromptsTitle.length)];
         if (document.querySelector(".packages_banner_title_dynamic") != null) {
             document.querySelector(".packages_banner_title_dynamic").innerHTML = upgradeBannerPromptsTitleRand;
         }
     </script>
...
<link rel="stylesheet" type="text/css" href="./orders_customers_files/individual_order.css">

<script>
    var local_currency_options = currency_options;

    function uc_getIndividualOrder(orderId, orderAbandoned) {
        hideById('modal_body_uc_abandoned_cart',
            'modal_body_uc_abandoned_cart_error',
            'uc_individual_order_view_order');
        showAllByClass('.busy_wait_uc_abandonedCart');
        fadeInClass('modal_getIndividualOrder', 'modal_overlay');
        document.body.classList.add('body_modal_is_open');
        axiosGet('../services/orders/CustomerOrder.svc/getOrder?storeId=' + storeId + '&orderId=' + orderId).then(
            function(data) {
                var ucIndividualOrders = data.d;
                if (ucIndividualOrders != null) {
                    local_currency_options = JSON.parse(ucIndividualOrders[2]);
                    
                    buildUcIndividualOrder(JSON.parse(ucIndividualOrders[1]), orderAbandoned, ucIndividualOrders[0]);
                    showById('modal_body_uc_abandoned_cart');
                } else {
                    showById('modal_body_uc_abandoned_cart_error');
                    hideById('modal_body_uc_abandoned_cart');
                }
            }).catch().then(function() {
            hideAllByClass('.busy_wait_uc_abandonedCart');
        });
    }

    function buildUcIndividualOrder(o, orderAbandoned, total) {

        console.log("Build UC")
        console.log(o);

        // Add View Order Button 
        if (o.id != undefined && orderAbandoned !== true) {
            document.getElementById('uc_individual_order_view_order').setAttribute('href', '/orders_item.aspx?oid=' + o.id);
            showById('uc_individual_order_view_order');
        }

        // Add Delivery Address
        var orderDeliveryAddress = "";
        console.log(o.delivery_address);

        if (o.delivery_address != null) {
            if (o.delivery_address.companyname != undefined) {
                if (o.delivery_address.companyname.length > 0) {
                    orderDeliveryAddress = "<p><strong>" + o.delivery_address.companyname + "</strong></p>";
                }
            }
            orderDeliveryAddress += '<p>' + o.delivery_address.forename + ' ' + o.delivery_address.surname + '</p>';
            if (o.delivery_address.address1 != null) { orderDeliveryAddress += '<p>' + o.delivery_address.address1 + '</p>' }
            if (o.delivery_address.address2 != null) { orderDeliveryAddress += '<p>' + o.delivery_address.address2 + '</p>' }
            if (o.delivery_address.address3 != null) { orderDeliveryAddress += '<p>' + o.delivery_address.address3 + '</p>' }
            if (o.delivery_address.city != null) { orderDeliveryAddress += '<p>' + o.delivery_address.city + '</p>' }
            if (o.delivery_address.county != null) { orderDeliveryAddress += '<p>' + o.delivery_address.county + '</p>' }
            if (o.delivery_address.postcode != null) { orderDeliveryAddress += '<p>' + o.delivery_address.postcode + '</p>' }
            if (o.delivery_address.country != null) { orderDeliveryAddress += '<p>' + o.delivery_address.country + '</p>' }
            if (o.delivery_address.telephone != null) { orderDeliveryAddress += '<p>' + o.delivery_address.telephone + '</p>' }
            if (o.delivery_address.mobile != null) { orderDeliveryAddress += '<p>' + o.delivery_address.mobile + '</p>' }

            document.getElementById("uc_orders_address_right_content_delivery").innerHTML = orderDeliveryAddress;
        }


        if (o.billing_address != null) {
            var orderBillingAddress = "";
            if (o.billing_address.companyname != undefined) {
                if (o.billing_address.companyname.length > 0) {
                    orderBillingAddress = "<p><strong>" + o.billing_address.companyname + "</strong></p>";
                }
            }
            orderBillingAddress += '<p>' + o.billing_address.forename + ' ' + o.billing_address.surname + '</p>';
            if (o.billing_address.address1 != null) { orderBillingAddress += '<p>' + o.billing_address.address1 + '</p>' }
            if (o.billing_address.address2 != null) { orderBillingAddress += '<p>' + o.billing_address.address2 + '</p>' }
            if (o.billing_address.address3 != null) { orderBillingAddress += '<p>' + o.billing_address.address3 + '</p>' }
            if (o.billing_address.city != null) { orderBillingAddress += '<p>' + o.billing_address.city + '</p>' }
            if (o.billing_address.county != null) { orderBillingAddress += '<p>' + o.billing_address.county + '</p>' }
            if (o.billing_address.postcode != null) { orderBillingAddress += '<p>' + o.billing_address.postcode + '</p>' }
            if (o.billing_address.country != null) { orderBillingAddress += '<p>' + o.billing_address.country + '</p>' }
            if (o.billing_address.telephone != null) { orderBillingAddress += '<p>' + o.billing_address.telephone + '</p>' }
            if (o.billing_address.mobile != null) { orderBillingAddress += '<p>' + o.billing_address.mobile + '</p>' }

            document.getElementById("uc_orders_address_right_content_billing").innerHTML = orderBillingAddress;
        } else {
            if (o.delivery_address != null) {
                document.getElementById("uc_orders_address_right_content_billing").innerHTML = orderDeliveryAddress;
            }
        }

        document.getElementById("uc_orders_address_right_content_customer_email").innerHTML = '<a href="mailto:' + o.email + '" class="link_color_primary">' + o.email + '</a>';
        var theTelephone = "";

        if (o.billing_address != null && o.billing_address.telephone != null) {
            if (o.billing_address.telephone.length > 0) {
                theTelephone = o.billing_address.telephone + " (billing)";
            } 
        } else {
            if (o.delivery_address.telephone != undefined) {
                if (o.delivery_address.telephone.length > 0) {
                    theTelephone = o.delivery_address.telephone + " (delivery)";
                }
            }
        }

        if (theTelephone.length > 0) {
            document.getElementById("uc_orders_address_right_content_customer_telephone").innerHTML = theTelephone;
            showById('uc_orders_address_right_content_customer_telephone_container');
        } else {
            hideById('uc_orders_address_right_content_customer_telephone_container');
        }

        var theCustomerAccountType = "Guest";
        if (o.customerAccountType != null) {
            if (o.customerAccountType == 1) {
                theCustomerAccountType = "Registered";
            }
        }

        document.getElementById("uc_orders_address_right_content_customer_type").innerText = theCustomerAccountType;

        // Add products to table
        var orderProductTable = document.getElementById("uc_orders_products_table_body");
        var orderProductContent = "";
        if (o.order_details != undefined) {
            for (var i = 0; i < o.order_details.length; i++) {

                var orderProductOptionDesc = "";
                var orderProductOptionSpacing = "";
                var orderProductOptionNet = "";
                var orderProductOptionVat = "";

                if (o.order_details[i].options != undefined && o.order_details[i].options.length > 0) {
                    for (var v = 0; v < o.order_details[i].options.length; v++) {
                        console.log(o.order_details[i].options[v])
                        orderProductOptionDesc += '<br /><span class="italic">' + o.order_details[i].options[v].description + '</span>';
                        orderProductOptionSpacing += '<br /><span>1</span>';
                        orderProductOptionNet += '<br /><span>' + accounting.formatMoney(o.order_details[i].options[v].net, local_currency_options) + '</span>';
                        orderProductOptionVat += '<br /><span>' + accounting.formatMoney(o.order_details[i].options[v].tax, local_currency_options) + '</span>';
                    }
                } else {
                    orderProductOptionDesc = "";
                    orderProductOptionSpacing = "";
                    orderProductOptionNet = "";
                    orderProductOptionVat = "";
                }

                var orderProduct = "";
                orderProduct += '<tr>';
                orderProduct += '<td><strong>' + o.order_details[i].description + '</strong>' + orderProductOptionDesc + '</td>';
                orderProduct += '<td>' + o.order_details[i].quantity + orderProductOptionSpacing + '</td>';
                orderProduct += '<td>' + accounting.formatMoney(o.order_details[i].net, local_currency_options) + orderProductOptionNet + '</td>';
                orderProduct += '<td>' + accounting.formatMoney(o.order_details[i].vat, local_currency_options) + orderProductOptionVat + '</td>';
                orderProduct += '</tr>';

                orderProductContent += orderProduct
            }
            orderProductTable.innerHTML = orderProductContent;
        }

        if (o.checkout_error != null && o.checkout_error.feedback != null) {
            var _html = "";
            _html += "<li>Code: " + o.checkout_error.code + "</li>";
            _html += "<li>Feedback: " + o.checkout_error.feedback + "</li>";
            _html += "<li>Debug Info:<br/>" + o.checkout_error.text + "</li>";
            getId('order_note_history').innerHTML = _html;
            showById('ao_order_note');
        } else {
            hideById('ao_order_note');
        }
        ...
        // Add Order Prices
        document.getElementById("uc_orders_product_net").innerHTML = accounting.formatMoney(o.net, local_currency_options);
        document.getElementById("uc_orders_product_deductions").innerHTML = accounting.formatMoney(o.discount, local_currency_options);
        document.getElementById("uc_orders_product_salestax").innerHTML = accounting.formatMoney(o.tax, local_currency_options);
        document.getElementById("uc_orders_product_postage").innerHTML = accounting.formatMoney(o.postage, local_currency_options);
        document.getElementById("uc_orders_product_postagetax").innerHTML = accounting.formatMoney(o.postagetax, local_currency_options);
        document.getElementById("uc_orders_product_total").innerHTML = accounting.formatMoney(parseFloat(total), local_currency_options);

    }

    $(document).ready(function () {

        $(".uc_orders_address_left_item").click(function () {
            $(".uc_orders_address_left_item").removeClass("uc_orders_address_left_item_active");
            $(this).addClass("uc_orders_address_left_item_active");

            var uc_orderAddressId = $(this).attr("id");

            $(".uc_orders_address_right_item").removeClass("uc_orders_address_right_item_active");

            if (uc_orderAddressId === "uc_orders_address1") {
                $(".uc_orders_address_right_item1").addClass("uc_orders_address_right_item_active");
            } else if (uc_orderAddressId === "uc_orders_address2") {
                $(".uc_orders_address_right_item2").addClass("uc_orders_address_right_item_active");
            } else {
                $(".uc_orders_address_right_item3").addClass("uc_orders_address_right_item_active");
            }
...
<div class="modal modal_getIndividualOrder">
    <div class="modal_header">
        <div class="modal_title">Order Details</div>
        <div class="modal_expand" data-expand="normal"><i class="fa fa-window-maximize" aria-hidden="true"></i></div>
        <div class="modal_close"><i class="fa fa-times" aria-hidden="true"></i></div>
    </div>
    <div class="modal_body_outer_container">
        <div class="busy_wait busy_wait_static busy_wait_uc_abandonedCart">
            <div class="busy_wait_content">
                <div class="sk-cube-grid">
                    <div class="sk-cube sk-cube1"></div>
                    <div class="sk-cube sk-cube2"></div>
        ...
        <div id="modal_body_uc_abandoned_cart" class="modal_body">
            
            <div class="hide_overflow">
                <div class="panel_white uc_orders_address">
                    <div class="uc_orders_address_left">
                        <div id="uc_orders_address1" class="uc_orders_address_left_item"><i class="fa fa-truck" aria-hidden="true"></i></div>
                        <div id="uc_orders_address2" class="uc_orders_address_left_item"><i class="fa fa-credit-card-alt" aria-hidden="true"></i></div>
                        <div id="uc_orders_address3" class="uc_orders_address_left_item uc_orders_address_left_item_active"><i class="fa fa-user" aria-hidden="true"></i></div>
                    </div>
                    <div class="uc_orders_address_right">
                        <div class="uc_orders_address_right_item uc_orders_address_right_item1">
                            <div class="uc_orders_addres_right_title">Delivery Address</div>
                            <div id="uc_orders_address_right_content_delivery" class="uc_orders_address_right_content"></div>
                        </div>
                        <div class="uc_orders_address_right_item uc_orders_address_right_item2">
                            <div class="uc_orders_addres_right_title">Billing Address</div>
                            <div id="uc_orders_address_right_content_billing" class="uc_orders_address_right_content"></div>
                        </div>
                        <div class="uc_orders_address_right_item uc_orders_address_right_item3 uc_orders_address_right_item_active">
                            <div class="uc_orders_addres_right_title">Customer Details</div>
                            <div id="uc_orders_address_right_content_customer" class="uc_orders_address_right_content">
                                <p><strong>Email:</strong> <span id="uc_orders_address_right_content_customer_email"></span></p>
                                <p id="uc_orders_address_right_content_customer_telephone_container"><strong>Telephone:</strong> <span id="uc_orders_address_right_content_customer_telephone"></span></p>
                                <p><strong>Customer Type:</strong> <span id="uc_orders_address_right_content_customer_type"></span></p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="table_container" id="uc_orders_products_table">
                <table>
                    <thead>
                        <tr>
                            <th>Product</th>
                    ...
                    <tbody id="uc_orders_products_table_body"></tbody>
                </table>
                <div id="order_view_products_breakdown">
                    <div class="order_view_products_breakdown_item">
                        <div id="uc_orders_product_net" class="order_view_products_breakdown_right"></div>
                        <div class="order_view_products_breakdown_left">Net:</div>
                    </div>
                    <div class="order_view_products_breakdown_item">
                        <div id="uc_orders_product_deductions" class="order_view_products_breakdown_right"></div>
                        <div class="order_view_products_breakdown_left order_view_products_discounts">Deductions:</div>
                    </div>
                    <div class="order_view_products_breakdown_item">
                        <div id="uc_orders_product_salestax" class="order_view_products_breakdown_right"></div>
                        <div class="order_view_products_breakdown_left">Sales Tax:</div>
                    </div>
                    <div class="order_view_products_breakdown_item">
                        <div id="uc_orders_product_postage" class="order_view_products_breakdown_right"></div>
                        <div class="order_view_products_breakdown_left">Postage:</div>
                    </div>
                    <div class="order_view_products_breakdown_item">
                        <div id="uc_orders_product_postagetax" class="order_view_products_breakdown_right"></div>
                        <div class="order_view_products_breakdown_left">Postage Tax:</div>
                    </div>
                    <div id="uc_orders_product_total" class="order_view_products_breakdown_item order_view_products_breakdown_final"></div>
                </div>
            </div>
            <div id="ao_order_note">
                <div class="notes_item">
                    <div class="notes_item_date">Processor Reason</div>
                    <div class="notes_item_message">
                        <ul id="order_note_history" class="ul_with_small_spaces"></ul>
                    </div>
                </div>
            </div>
        </div>
        <div id="modal_body_uc_abandoned_cart_error" class="modal_body">
            <h2 class="margint10">Unable to Load Order</h2>
            <p>Sorry, we were unable to load this order, please try again later or get in touch with our support team.</p>
        </div>
    </div>
    <div class="modal_footer">
        <a class="button button_dgrey modal_footer_left close_modal_button">Close</a>
        <a class="button button_primary modal_footer_right" id="uc_individual_order_view_order">View Order</a>
    </div>
</div>



    <div class="modal_links modal_link_customer">
        <h2 class="color_white">Add Customer</h2>
        <div class="modal_links_body">

            <div class="modal_links_body_item">
                <i class="fa fa-user" aria-hidden="true"></i>
                <strong>Add Customer</strong>
                <div class="color_primary">Coming Soon</div>
                <p>Manually Add Customer Accounts</p>
                <a class="button button_primary button_disabled">Coming Soon</a>
            </div>
...
<script>
    ...
    <script src="./orders_customers_files/t.js.download"></script>
    <script>
    ...
    <script src="./orders_customers_files/css_variables.js.download"></script>
